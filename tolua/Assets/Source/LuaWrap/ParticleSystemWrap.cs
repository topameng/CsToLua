...
public class ParticleSystemWrap
{
	public static void Register(IntPtr L)
	{
		...
		LuaScriptMgr.RegisterLib(L, "UnityEngine.ParticleSystem", typeof(UnityEngine.ParticleSystem), regs, fields, typeof(Component));
	}
	...
	static int Emit(IntPtr L)
	{
		...
		if (count == 2 && LuaScriptMgr.CheckTypes(L, 2, typeof(ParticleSystem.Particle)))
		{
			ParticleSystem obj = (ParticleSystem)LuaScriptMgr.GetUnityObjectSelf(L, 1, "ParticleSystem");
		...
		else if (count == 2 && LuaScriptMgr.CheckTypes(L, 2, typeof(int)))
		{
			ParticleSystem obj = (ParticleSystem)LuaScriptMgr.GetUnityObjectSelf(L, 1, "ParticleSystem");
