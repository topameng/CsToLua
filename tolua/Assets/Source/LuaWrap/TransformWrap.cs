...
public class TransformWrap
{
	public static void Register(IntPtr L)
	{
		...
		LuaScriptMgr.RegisterLib(L, "UnityEngine.Transform", typeof(UnityEngine.Transform), regs, fields, typeof(Component));
	}
	...
	static int Translate(IntPtr L)
	{
		...
		else if (count == 3 && LuaScriptMgr.CheckTypes(L, 2, typeof(LuaTable), typeof(Transform)))
		{
			Transform obj = (Transform)LuaScriptMgr.GetUnityObjectSelf(L, 1, "Transform");
			Vector3 arg0 = LuaScriptMgr.GetVector3(L, 2);
		...
		else if (count == 3 && LuaScriptMgr.CheckTypes(L, 2, typeof(LuaTable), typeof(Space)))
		{
			Transform obj = (Transform)LuaScriptMgr.GetUnityObjectSelf(L, 1, "Transform");
			Vector3 arg0 = LuaScriptMgr.GetVector3(L, 2);
		...
		else if (count == 5 && LuaScriptMgr.CheckTypes(L, 2, typeof(float), typeof(float), typeof(float), typeof(Transform)))
		{
			Transform obj = (Transform)LuaScriptMgr.GetUnityObjectSelf(L, 1, "Transform");
		...
		else if (count == 5 && LuaScriptMgr.CheckTypes(L, 2, typeof(float), typeof(float), typeof(float), typeof(Space)))
		{
			Transform obj = (Transform)LuaScriptMgr.GetUnityObjectSelf(L, 1, "Transform");
			float arg0 = (float)LuaDLL.lua_tonumber(L, 2);
			float arg1 = (float)LuaDLL.lua_tonumber(L, 3);
	...
	static int Rotate(IntPtr L)
	{
		...
		else if (count == 3 && LuaScriptMgr.CheckTypes(L, 2, typeof(LuaTable), typeof(float)))
		{
			Transform obj = (Transform)LuaScriptMgr.GetUnityObjectSelf(L, 1, "Transform");
			Vector3 arg0 = LuaScriptMgr.GetVector3(L, 2);
			float arg1 = (float)LuaDLL.lua_tonumber(L, 3);
		...
		else if (count == 4 && LuaScriptMgr.CheckTypes(L, 2, typeof(LuaTable), typeof(float), typeof(Space)))
		{
			Transform obj = (Transform)LuaScriptMgr.GetUnityObjectSelf(L, 1, "Transform");
			Vector3 arg0 = LuaScriptMgr.GetVector3(L, 2);
			float arg1 = (float)LuaDLL.lua_tonumber(L, 3);
		...
		else if (count == 4 && LuaScriptMgr.CheckTypes(L, 2, typeof(float), typeof(float), typeof(float)))
		{
			Transform obj = (Transform)LuaScriptMgr.GetUnityObjectSelf(L, 1, "Transform");
			float arg0 = (float)LuaDLL.lua_tonumber(L, 2);
			float arg1 = (float)LuaDLL.lua_tonumber(L, 3);
	...
	static int LookAt(IntPtr L)
	{
		...
		if (count == 2 && LuaScriptMgr.CheckTypes(L, 2, typeof(LuaTable)))
		{
			Transform obj = (Transform)LuaScriptMgr.GetUnityObjectSelf(L, 1, "Transform");
			Vector3 arg0 = LuaScriptMgr.GetVector3(L, 2);
			obj.LookAt(arg0);
		...
		else if (count == 2 && LuaScriptMgr.CheckTypes(L, 2, typeof(Transform)))
		{
			Transform obj = (Transform)LuaScriptMgr.GetUnityObjectSelf(L, 1, "Transform");
		...
		else if (count == 3 && LuaScriptMgr.CheckTypes(L, 2, typeof(LuaTable), typeof(LuaTable)))
		{
			Transform obj = (Transform)LuaScriptMgr.GetUnityObjectSelf(L, 1, "Transform");
			Vector3 arg0 = LuaScriptMgr.GetVector3(L, 2);
			Vector3 arg1 = LuaScriptMgr.GetVector3(L, 3);
		...
		else if (count == 3 && LuaScriptMgr.CheckTypes(L, 2, typeof(Transform), typeof(LuaTable)))
		{
			Transform obj = (Transform)LuaScriptMgr.GetUnityObjectSelf(L, 1, "Transform");
			Transform arg0 = (Transform)LuaScriptMgr.GetLuaObject(L, 2);
			Vector3 arg1 = LuaScriptMgr.GetVector3(L, 3);
