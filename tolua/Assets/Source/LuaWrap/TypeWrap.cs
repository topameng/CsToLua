...
public class TypeWrap
{
	...
	{
		LuaScriptMgr.PushObject(L, Type.EmptyTypes);
		return 1;
	}
	...
	{
		LuaScriptMgr.Push(L, Type.Missing);
		return 1;
	}
	...
	static int get_BaseType(IntPtr L)
	{
		...
		Type obj = (Type)o;
		LuaScriptMgr.PushObject(L, obj.BaseType);
		return 1;
	}
	...
	static int get_DeclaringType(IntPtr L)
	{
		...
		Type obj = (Type)o;
		LuaScriptMgr.PushObject(L, obj.DeclaringType);
		return 1;
	}
	...
	static int get_ReflectedType(IntPtr L)
	{
		...
		Type obj = (Type)o;
		LuaScriptMgr.PushObject(L, obj.ReflectedType);
		return 1;
	}
	...
	static int get_UnderlyingSystemType(IntPtr L)
	{
		...
		Type obj = (Type)o;
		LuaScriptMgr.PushObject(L, obj.UnderlyingSystemType);
		return 1;
	}
