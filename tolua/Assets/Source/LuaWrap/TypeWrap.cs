...
public class TypeWrap
{
	public static void Register(IntPtr L)
	{
		...
		LuaScriptMgr.RegisterLib(L, "System.Type", typeof(System.Type), regs, fields, typeof(System.Object));
	}
	...
	static int GetMethod(IntPtr L)
	{
		...
		else if (count == 3 && LuaScriptMgr.CheckTypes(L, 2, typeof(string), typeof(Type[])))
		{
			Type obj = LuaScriptMgr.GetTypeObject(L, 1);
		...
		else if (count == 3 && LuaScriptMgr.CheckTypes(L, 2, typeof(string), typeof(System.Reflection.BindingFlags)))
		{
			Type obj = LuaScriptMgr.GetTypeObject(L, 1);
			string arg0 = LuaScriptMgr.GetString(L, 2);
